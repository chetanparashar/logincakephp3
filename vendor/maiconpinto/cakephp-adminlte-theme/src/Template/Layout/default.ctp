    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="<?php echo $this->Url->build('/'); ?>" class="logo">
                ...
                <span class="logo-lg">API PANEL</span>
            </a>
            <!-- Header Navbar: style can be found in header.less -->
            <?php echo $this->element('lte_nav_top') ?>
        </header>

        <!-- Left side column. contains the sidebar -->
        <?php echo $this->element('lte_menu'); ?>

        <!-- =============================================== -->

        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper" style="padding-top: 25px;padding-left: 10px;padding-right: 10px">
        ...
        <?php echo $this->element('lte_footer'); ?>
