...
<?= $this->Form->create() ?>
    <fieldset>        
        <legend> <span style="color: red;font-size: 14px;margin-top: 10px;text-align:center;"><?= ($response['error'] == TRUE) ? $response['msg'] : '&nbsp' ?></span></legend>
...
//            echo $this->Form->unlockField('password');
        ...
        <button type="submit"  class="btn btn-primary btn-block" ng-click="login()">Login</button>
    </fieldset>
